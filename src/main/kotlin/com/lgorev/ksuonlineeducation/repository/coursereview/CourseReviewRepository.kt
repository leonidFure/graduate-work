...
interface CourseReviewRepository : CrudRepository<CourseReviewEntity, CourseReviewId> {
    @Query("SELECT new CourseRatingEntity(e.courseReviewId.courseId, CASE WHEN COUNT(e) > 0 THEN (AVG(e.rating)) ELSE 0.0 END, COUNT(e)) FROM CourseReviewEntity e WHERE e.courseReviewId.courseId = :courseId")
